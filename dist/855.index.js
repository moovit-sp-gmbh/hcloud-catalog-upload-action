...
const property_provider_1 = __webpack_require__(4717);
const shared_ini_file_loader_1 = __webpack_require__(263);
const node_fs_1 = __webpack_require__(3024);
const fromWebToken_1 = __webpack_require__(5308);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(2886)));
...
var fromTokenFile = __webpack_require__(3676);
var fromWebToken = __webpack_require__(5308);
